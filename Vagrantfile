...
Vagrant.configure(2) do |config|
  ...
  config.vm.synced_folder "../../../", "/home/vagrant/#{projectname}/project"
  # mount the Narthex git repo for development
  # config.vm.synced_folder "../../../../", "/home/vagrant/#{projectname}/narthex"
